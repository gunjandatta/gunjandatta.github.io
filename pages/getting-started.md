...
### Core REST API
```html
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/gd-sprest/7.3.6/gd-sprest.min.js"></script>
```
```js
...
### Bootstrap
```html
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/gd-sprest-bs/10.9.2/gd-sprest-bs.min.js"></script>
```
```js
var s = document.createElement("script"); s.src = "https://cdnjs.cloudflare.com/ajax/libs/gd-sprest-bs/10.9.2/gd-sprest-bs.min.js"; document.head.appendChild(s);
```
...
s.src = "https://cdnjs.cloudflare.com/ajax/libs/gd-sprest/7.3.6/gd-sprest.min.js";
